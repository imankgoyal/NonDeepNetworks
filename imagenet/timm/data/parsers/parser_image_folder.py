...
def find_images_and_targets(folder, types=IMG_EXTENSIONS, class_to_idx=None,
                            leaf_name_only=True, sort=True, min_count=0):
    labels = []
    filenames = []
...
class ParserImageFolder(Parser):
    ...
    def __init__(
        ...
        self.samples, self.class_to_idx = find_images_and_targets(
            root, class_to_idx=class_to_idx, min_count=min_count)
